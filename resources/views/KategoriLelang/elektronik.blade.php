...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="jumbotron jumbotron-fluid text-white" style="background-color: #488482;">
        <div class="container">
            <img src="{{ asset ('img') }}/elektronik.png" class="float-left" alt="bit" width="400" height="200" >
            <img src="{{ asset ('img') }}/ft.png" class="float-right" alt="bit" width="300" height="200" >
            <div class="text-right">
                <h1 class="display-4">Elektronik</h1>
                <p class="lead">Barang elektronik tidak terpakai?</p>
                <p class="lead">Beli barang elektronik murah?</p>
                <p class="lead">E-Lelang Aja</p> 
            </div>
        </div>
    </div>
...
<div class="card" style="width: 12rem;">
  <img src="{{ asset ('img') }}/ip.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<!-- <div class="lelang-menu">
  <img src="{{ asset ('img') }}/ipon.png" alt="Gambar 1">
  <h3>Menu Lelang 1</h3>
  <p>Informasi tentang menu lelang 1.</p>
  <button>More</button>
</div>

<div class="lelang-menu">
  <img src="{{ asset ('img') }}/ip.jpg" alt="Gambar 2">
  <h3>Menu Lelang 2</h3>
  <p>Informasi tentang menu lelang 2.</p>
  <button>More</button>
</div>

<div class="lelang-menu">
  <img src="{{ asset ('img') }}/lptp.jpeg" alt="Gambar 3">
  <h3>Menu Lelang 2</h3>
  <p>Informasi tentang menu lelang 2.</p>
  <button>More</button>
</div>
...
<div class="lelang-menu">
  <img src="{{ asset ('img') }}/kolkas.jpg" alt="Gambar 4">
  <h3>Menu Lelang 2</h3>
  <p>Informasi tentang menu lelang 2.</p>
  <button>More</button>
</div>
...
<div class="lelang-menu">
  <img src="{{ asset ('img') }}/hardisk.jpg" alt="Gambar 5">
  <h3>Menu Lelang 2</h3>
  <p>Informasi tentang menu lelang 2.</p>
  <button>More</button>
</div> -->
