...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="jumbotron jumbotron-fluid text-white" style="background-color: #488482;">
        <div class="container">
            <img src="{{ asset ('img/kendaraan') }}/mbl.png" class="float-right" alt="bit" width="450" height="300" >
            <div class="text-left">
                <h1 class="display-4">Kendaraan</h1>
            </div>
                <div class="lead">
                    <p class="lead">Kendaraan Lamamu belum laku terjual ? </p>
                    <p class="lead">Coba titipkan di E-Lelang Kota Jogja</p>
                </div>
        </div>
    </div>
